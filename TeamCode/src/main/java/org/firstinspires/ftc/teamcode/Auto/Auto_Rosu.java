...
public class Auto_Rosu extends OpMode {
    ...
    private final Pose startPose = new Pose(12,180,Math.toRadians(90));
    private final Pose Stem =new Pose(132,40,Math.toRadians(-90));
    private final Pose Polen =new Pose(108,228,Math.toRadians(0));
    private final Pose[] Parkings ={
            new Pose(108,60,Math.toRadians(0)),  //case 1
            new Pose(108,108,Math.toRadians(0)),  //case 2
            new Pose(108,156,Math.toRadians(0))}; //case 3
